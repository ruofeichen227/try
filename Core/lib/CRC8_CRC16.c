...
/**
  * @brief          calculate the crc8 计算CRC8
  * @param[in]      pch_message: data
  * @param[in]      dw_length: stream length = data + checksum
  * @param[in]      ucCRC8: init CRC8 初始CRC8
  * @retval         calculated crc8 计算完的CRC8
  */
...
/**
  * @brief          CRC8 verify function CRC8校验函数
  * @param[in]      pch_message: data
  * @param[in]      dw_length:stream length = data + checksum
...
/**
  * @brief          append CRC8 to the end of data 添加CRC8到数据的结尾
  * @param[in]      pch_message: data
  * @param[in]      dw_length:stream length = data + checksum
  * @retval         none
  */
...
/**
  * @brief          calculate the crc16 计算CRC16
  * @param[in]      pch_message: data
  * @param[in]      dw_length: stream length = data + checksum
  * @param[in]      wCRC: init CRC16 初始CRC16
  * @retval         calculated crc16 计算完的CRC16
  */
...
/**
  * @brief          CRC16 verify function CRC16校验函数
  * @param[in]      pch_message: data
  * @param[in]      dw_length:stream length = data + checksum
  * @retval         true of false
  */
...
/**
  * @brief          append CRC16 to the end of data 添加CRC16到数据的结尾
  * @param[in]      pch_message: data
  * @param[in]      dw_length:stream length = data + checksum
  * @retval         none
  */
